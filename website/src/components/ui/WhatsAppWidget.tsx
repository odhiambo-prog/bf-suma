...
export default function WhatsAppWidget() {
  ...
  const containerVariants = {
    ...
    visible: {
      ...
      x: 0,
      scale: 1,
      transition: { type: 'spring' as const, stiffness: 300, damping: 20, delay: 1 },
    },
  }
    ...
    <>
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.92 }}
          className="w-14 h-14 bg-[#25D366] hover:bg-[#22c35e] rounded-full flex items-center justify-center shadow-lg cursor-pointer flex-shrink-0"
